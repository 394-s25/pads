      ...
      <div className="container mx-auto p-6 max-w-4xl">
        <header className="mb-8 border-b border-gray-300 pb-4">
          ...
          <div className="flex gap-4 mt-4">
            <Link to="/create" className={tabClass("/create")}>Create Report</Link>
            <Link to="/drafts" className={tabClass("/drafts")}>Saved Drafts</Link>
            <Link to="/status" className={tabClass("/status")}>Report Status</Link>
          </div>
        </header>
