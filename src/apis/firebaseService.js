...
/**
 * Function to update specific fields in a report
...
export async function updateReport(reportId, updates) {
  try {
    ...
    console.log(`Successfully updated report ${reportId} with:`, updates);
  } catch (error) {
...
export async function updateIsResolved(reportId, isResolved) {
  try {
    ...
    console.log(
      `Successfully updated isResolved to ${isResolved} for report ID: ${reportId}`
    );
  } catch (error) {
